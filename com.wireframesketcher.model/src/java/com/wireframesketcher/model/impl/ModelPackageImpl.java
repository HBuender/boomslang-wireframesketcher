...
import com.wireframesketcher.model.Frame;
...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @generated
	 */
	private EClass clickSupportEClass = null;
	 ...
	 * @generated
	 */
	private EClass visibleSupportEClass = null;
	 ...
	 * @generated
	 */
	public EClass getClickSupport() {
		return clickSupportEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getTextInputSupport() {
		return textInputSupportEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getVisibleSupport_Visible() {
		return (EAttribute)visibleSupportEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		clickSupportEClass = createEClass(CLICK_SUPPORT);
	...
	public void initializePackageContents() {
		...
		buttonEClass.getESuperTypes().add(this.getClickSupport());
		...
		textFieldEClass.getESuperTypes().add(this.getTextInputSupport());
		...
		itemEClass.getESuperTypes().add(this.getClickSupport());
		itemEClass.getESuperTypes().add(this.getLinkSupport());
		itemEClass.getESuperTypes().add(this.getVisibleSupport());
		...
		initEAttribute(getFont_Size(), this.getFontSizeDataType(), "size", "10", 1, 1, Font.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFont_Bold(), ecorePackage.getEBooleanObject(), "bold", "false", 1, 1, Font.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFont_Italic(), ecorePackage.getEBooleanObject(), "italic", "false", 1, 1, Font.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFont_Underline(), ecorePackage.getEBooleanObject(), "underline", "false", 1, 1, Font.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(iconSizeEEnum, IconSize.XXL_LITERAL);
